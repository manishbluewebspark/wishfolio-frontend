    ...
    <div className="npmc-close-btn-con" onClick={onClose}>
      ...
      <div className="got-u-req-box text-center">
        ...
        <div className="got-u-req-box-form">
            ...
            <p className="got-u-req-subtext">We’ve received your wish product request. It will be delivered to your address within <strong>2-14 working days</strong>. Once you receive your product, please share your review with us.</p>
          <button
            type="submit"
