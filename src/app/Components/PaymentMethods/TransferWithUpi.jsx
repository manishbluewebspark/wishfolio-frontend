...
const TransferWithUpi = () => {
    return (
        <div className="container twu-container">
            ...
            <p className="twu-title">You can transfer the money to the bank account below and submit your transaction ID.</p>
            ...
            <div className="twu-amount-section">
                <div className="twu-row">
                    ...
                    <span className="twu-balance">₹ 5,000</span>
                </div>

                <div className="twu-row">
                    <span className="twu-label">Platform Commission 15%</span>
                    <span className="twu-balance">₹ 750</span>
                </div>
            </div>
            ...
            <div className="twu-final-amount-box">
                ...
                <span className="twu-final-amount-value">₹ 4,250</span>
            </div>
        </div>
    );
};
