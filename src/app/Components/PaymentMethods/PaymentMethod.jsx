      ...
      <div className="ptm-payment-options">
        ...
        <div className="ptm-payment-method d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center">
            <Image src={bank} alt="Bank Transfer" className="ptm-icon" width={119} height={24} />
          </div>
          <Image src={arrowright} alt="Arrow Right" className="ptm-arrow" width={20} height={20} />
        </div>

        {/* Payment Method 2 */}
        <div className="ptm-payment-method d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center">
            <Image src={googleupi} alt="Google Pay" className="ptm-icon" width={150} height={27.19} />
          </div>
          <Image src={arrowright} alt="Arrow Right" className="ptm-arrow" width={20} height={20} />
        </div>
        ...
        <div className="ptm-payment-method d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center">
            <Image src={phoneupi} alt="PhonePe" className="ptm-icon" width={114} height={32} />
          </div>
          <Image src={arrowright} alt="Arrow Right" className="ptm-arrow" width={20} height={20} />
        </div>
        ...
        <div className="ptm-payment-method d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center">
            <Image src={paytmupi} alt="Paytm" className="ptm-icon" width={72} height={23} />
          </div>
          <Image src={arrowright} alt="Arrow Right" className="ptm-arrow" width={20} height={20} />
        </div>
        ...
        <div className="ptm-payment-method d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center">
            <Image src={bhimupi} alt="BHIM" className="ptm-icon" width={100} height={24} />
          </div>
          <Image src={arrowright} alt="Arrow Right" className="ptm-arrow" width={20} height={20} />
        </div>
