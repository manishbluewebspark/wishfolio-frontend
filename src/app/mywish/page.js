    ...
    <>
     <div className="container-mw">
      ...
      <div className="mw-donation-section">
        <Image src={img2} height={75} width={100} className="mw-donate-img"></Image>
        <h5>More to Donate</h5>
        <p>You are currently not eligible for this Wish. Please complete your statistics to proceed.</p>
